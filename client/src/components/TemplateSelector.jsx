...
const TemplateSelector = ({ selectedTemplate , onChange }) => {
    ...
    const templates = [
        ...
        } ,
        {
            id: "modern",
            name: "Modern",
            preview: "A sleek, easily scannable format optimized for digital applications, utilizing modern fonts and visual hierarchy to highlight key achievements quickly."
        } ,
        {
            id: "minimal-image",
            name: "Minimal Image",

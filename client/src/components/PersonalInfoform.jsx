...
import { MapPin, Phone, User,Mail,BriefcaseBusiness , Linkedin , Globe } from "lucide-react";
    ...
    <div>
        ...
        <div className='flex items-center gap-2'>
            <label>
                ...
                <input type="file" accepts= "image/jpeg , image/png" className='hidden' onChange = {(e) => handleChange("image" , e.target.files[0]) } />
            </label>

  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex items-center gap-3'>
            <input type="text" placeholder='Enter a Skill (e.g JavaScript , Java)' className='flex-1 px-3 py-2 text-sm' onChange={(e) => setNewSkill(e.target.value)} value={newSkill} onKeyDown={handleKeyPress} />
